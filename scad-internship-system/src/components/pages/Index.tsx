          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/internships" className="btn bg-scad-yellow hover:bg-opacity-90 text-scad-dark px-6 py-3 rounded-md font-medium">
                  Browse Internships
                </Link>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/internships" className="text-scad-red hover:underline font-medium">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/companies" className="text-scad-red hover:underline font-medium">
              View All Companies
            </Link>
          </div>
